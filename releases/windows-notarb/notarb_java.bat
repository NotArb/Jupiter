...
rem Ensure bot_path is defined
...
rem Run bot
"%java_exe_path%" --enable-preview %* -Dcaller_script_dir="%CD%" -cp "%bot_path%" org.notarb.launcher.Main "--jupiter-arb-config-path=%config_path%"
