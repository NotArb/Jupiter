...
_The bot is publicly available but is currently in its alpha stage and will undergo several changes. 
Feel free to follow the bot's program account to monitor its activity:_
